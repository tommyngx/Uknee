...
Its historical license text is retained verbatim in `LICENSE-APACHE-2.0` for
attribution and notice purposes. The combined repository is distributed under
the GNU Affero General Public License v3.0 in `LICENSE`.
