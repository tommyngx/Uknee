...
from landmark.data import load_inference_source
from landmark.data.augment import LetterBox
from landmark.nn.autobackend import AutoBackend
from landmark.core import DEFAULT_CFG, LOGGER, MACOS, WINDOWS, callbacks, colorstr, ops
from landmark.core.checks import check_imgsz, check_imshow
from landmark.core.files import increment_path
from landmark.core.torch_utils import attempt_compile, select_device, smart_inference_mode
...
class BasePredictor:
    ...
    def __call__(self, source=None, model=None, stream: bool = False, *args, **kwargs):
        ...
        Returns:
            (list[landmark.core.results.Results] | generator): Results objects or generator of Results objects.
        """
        self.stream = stream
        if stream:
    ...
    def stream_inference(self, source=None, model=None, *args, **kwargs):
        ...
        Yields:
            (landmark.core.results.Results): Results objects.
        """
