...
class Annotator:
    ...
    Examples:
        >>> from landmark.core.plotting import Annotator
...
def save_one_box(
    ...
    Examples:
        >>> from landmark.core.plotting import save_one_box
        >>> xyxy = [50, 50, 150, 150]
...
def plot_dashboard_pose(
    ...
    *,
    ...
    destination = Path(output_png) if output_png else csv_path.parent / "landmark_dashboard.png"
