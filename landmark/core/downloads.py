...
from landmark.core import ASSETS_URL, LOGGER, TQDM, checks, clean_url, emojis, is_online, url2file
...
def delete_dsstore(path: str | Path, files_to_delete: tuple[str, ...] = (".DS_Store", "__MACOSX")) -> None:
    ...
    Examples:
        >>> from landmark.core.downloads import delete_dsstore
...
def zip_directory(
    ...
    Examples:
        >>> from landmark.core.downloads import zip_directory
...
def unzip_file(
    ...
    Examples:
        >>> from landmark.core.downloads import unzip_file
...
def get_google_drive_file_info(link: str) -> tuple[str, str | None]:
    ...
    Examples:
        >>> from landmark.core.downloads import get_google_drive_file_info
...
def safe_download(
    ...
    Examples:
        >>> from landmark.core.downloads import safe_download
...
def attempt_download_asset(
    ...
    **kwargs,
    ...
    """
    from landmark.core import SETTINGS  # scoped for circular import
