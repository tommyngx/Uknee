...
from landmark.core.config import _YOLO_CLI_COMMAND, get_cfg, get_save_dir
from landmark.data.data_utils import check_cls_dataset, check_det_dataset, convert_ndjson_to_yolo_if_needed
from landmark.nn.distill_model import DistillationModel
from landmark.nn.tasks import load_checkpoint
from landmark.core.muon import MuSGD
...
from landmark.core.autobatch import check_train_batch_size
from landmark.core.checks import check_amp, check_file, check_imgsz, check_model_file_from_stem, print_args
from landmark.core.dist import ddp_cleanup, generate_ddp_command
from landmark.core.files import get_latest_run
from landmark.core.plotting import plot_results
...
class BaseTrainer:
    ...
    def _setup_train(self):
        ...
        for k, v in self.model.named_parameters():
            ...
            if any(x in k for x in freeze_layer_names):
                ...
                LOGGER.warning(
                    ...
                    "See landmark.core.trainer for customization of frozen layers."
                )
        ...
        if self.amp and RANK in {-1, 0}:  # Single-GPU and DDP
            ...
            self.amp = torch.tensor(check_amp(self.model, imgsz=self.args.imgsz), device=self.device)
        ...
        self.args.imgsz = check_imgsz(self.args.imgsz, stride=gs, floor=gs, max_dim=2, min_dim=2)
    ...
    def auto_batch(self, max_num_obj=0, dataset_size=0):
        ...
        max_imgsz = int(base_imgsz * (1 + self.args.multi_scale))  # need not be stride-aligned
...
class MultiTrainer:
    ...
    def train(self):
        ...
        from landmark.core.patches import torch_load, torch_save
    ...
    def plot_results(self):
        ...
        from landmark.core.config import TASK2METRIC
        from landmark.core.plotting import plot_multitrain_results
