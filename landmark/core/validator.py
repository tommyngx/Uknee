...
from landmark.core.config import get_cfg, get_save_dir
...
from landmark.core import LOCAL_RANK, LOGGER, RANK, TQDM, callbacks, colorstr, emojis
from landmark.core.checks import check_imgsz
from landmark.core.ops import Profile, linear_sum_assignment
...
class BaseValidator:
    ...
    def __init__(self, dataloader=None, save_dir=None, args=None, _callbacks: dict | None = None):
        ...
        self.args.imgsz = check_imgsz(self.args.imgsz, max_dim=2, min_dim=2)
    ...
    def __call__(self, trainer=None, model=None):
        ...
        if self.training:
            ...
            height, width = imgsz if isinstance(imgsz, (list, tuple)) else (imgsz, imgsz)
            model.warmup(imgsz=(1 if pt else self.args.batch, self.data["channels"], height, width))  # warmup
