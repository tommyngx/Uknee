...
from landmark.core import LOCAL_RANK, LOGGER, NUM_THREADS, TQDM, colorstr
from landmark.core.instance import Instances
from landmark.core.ops import resample_segments, segments2boxes
from landmark.core.torch_utils import TORCHVISION_0_18
...
class YOLODataset(BaseDataset):
    ...
    def build_transforms(self, hyp: dict | None = None) -> Compose:
        ...
        """
        target_shape = tuple(self.imgsz) if isinstance(self.imgsz, (list, tuple)) else (self.imgsz, self.imgsz)
        if self.augment:
            ...
            transforms = Compose([LetterBox(new_shape=target_shape, scaleup=False)])
        transforms.append(
            Format(
                bbox_format="xywh",
                normalize=True,
