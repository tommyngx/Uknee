...
from landmark.data.data_utils import FORMATS_HELP_MSG, HELP_URL, IMG_FORMATS, check_file_speeds
from landmark.core import DEFAULT_CFG, LOCAL_RANK, LOGGER, NUM_THREADS, TQDM
from landmark.core.patches import imread
    ...
    def check_cache_ram(self, safety_margin: float = 0.5) -> bool:
        ...
        for _ in range(n):
            ...
            if im is None:
                continue
            target_h, target_w = (
                self.imgsz if isinstance(self.imgsz, (list, tuple)) else (self.imgsz, self.imgsz)
            )
