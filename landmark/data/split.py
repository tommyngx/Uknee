...
from landmark.data.data_utils import IMG_FORMATS, img2label_paths
from landmark.core import DATASETS_DIR, LOGGER, TQDM
...
def autosplit(
    ...
    Examples:
        ...
        >>> from landmark.data.split import autosplit
        >>> autosplit()
