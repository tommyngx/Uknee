...
from landmark.nn.autobackend import check_class_names
from landmark.nn.modules import (
    AIFI,
    C1,
    C2,
    C2PSA,
...
from landmark.core.checks import REMOTE_FILE_PREFIXES, check_file, check_requirements, check_suffix, check_yaml
from landmark.core.loss import (
    E2ELoss,
    PoseLoss26,
...
from landmark.core.ops import make_divisible
from landmark.core.patches import torch_load
from landmark.core.plotting import feature_visualization
from landmark.core.torch_utils import (
    fuse_conv_and_bn,
    fuse_deconv_and_bn,
    initialize_weights,
    intersect_dicts,
...
from landmark.nn.modules.oa26 import (
    ConvNeXtV2N,
    ConvNeXtV2T,
    HRNet,
    HRNetLite,
...
from landmark.core.loss import OA26HeatmapPoseLoss, OA26SimCCPoseLoss
from landmark.core.loss import OA26RegionRefinePoseLoss
...
class RTDETRDetectionModel(DetectionModel):
    ...
    def init_criterion(self):
        ...
        raise NotImplementedError("RT-DETR is not part of the landmark pose-only runtime")
...
class WorldModel(DetectionModel):
    ...
    def get_text_pe(self, text, batch=80, cache_clip_model=True):
        ...
        """
        from landmark.nn.text_model import build_text_model
...
class YOLOEModel(DetectionModel):
    ...
    def loss(self, batch, preds=None):
        ...
        """
        if not hasattr(self, "criterion"):
            from landmark.core.loss import TVPDetectLoss
...
class YOLOESegModel(YOLOEModel, SegmentationModel):
    ...
    def loss(self, batch, preds=None):
        ...
        """
        if not hasattr(self, "criterion"):
            from landmark.core.loss import TVPSegmentLoss
...
# Checkpoints produced while the current package was temporarily named
# ``landmark2`` retain these fully-qualified pickle module paths. Keep the
# aliases scoped to checkpoint loading so ``import landmark2`` still fails
# normally and stale application imports are discovered promptly.
LEGACY_LANDMARK2_MODULES = {
    "landmark2": "landmark",
    "landmark2.core": "landmark.core",
    "landmark2.core.config": "landmark.core.config",
    "landmark2.core.loss": "landmark.core.loss",
    "landmark2.core.targets": "landmark.core.targets",
    "landmark2.core.plotting": "landmark.core.plotting",
    "landmark2.core.results": "landmark.core.results",
    "landmark2.data": "landmark.data",
    "landmark2.data.schema": "landmark.data.schema",
    "landmark2.models": "landmark.models",
    "landmark2.models.heatmap_adapter": "landmark.models.heatmap_adapter",
    "landmark2.models.hrnet": "landmark.models.hrnet",
    "landmark2.models.vitpose": "landmark.models.vitpose",
    "landmark2.models.rtmo": "landmark.models.rtmo",
    "landmark2.nn": "landmark.nn",
    "landmark2.nn.tasks": "landmark.nn.tasks",
    "landmark2.nn.modules": "landmark.nn.modules",
    "landmark2.nn.modules.block": "landmark.nn.modules.block",
    "landmark2.nn.modules.conv": "landmark.nn.modules.conv",
    "landmark2.nn.modules.head": "landmark.nn.modules.head",
    "landmark2.nn.modules.transformer": "landmark.nn.modules.transformer",
    "landmark2.nn.modules.oa26": "landmark.nn.modules.oa26",
    "landmark2.nn.modules.oa26.pose_heads": "landmark.nn.modules.oa26.pose_heads",
    "landmark2.nn.modules.oa26_region_refine": "landmark.nn.modules.oa26_region_refine",
    "landmark2.nn.modules.oa26_region_refine.pose_head": "landmark.nn.modules.oa26_region_refine.pose_head",
    "landmark2.utils": "landmark.utils",
    "landmark2.utils.api": "landmark.utils.api",
    "landmark2.utils.exporting": "landmark.utils.exporting",
    "landmark2.utils.results": "landmark.utils.results",
    "landmark2.utils.validation": "landmark.utils.validation",
}
...
class _SafeLoad:
    ...
    def _build(cls):
        ...
        import landmark.nn.modules as ul_nn
        import landmark.nn.tasks as ul_tasks
        ...
        from landmark.core.loss import E2EDetectLoss
        ...
        allow += [
            (nn.Identity, "landmark.nn.modules.block.Silence"),  # YOLOv9e
            (DetectionModel, "landmark.nn.tasks.YOLOv10DetectionModel"),  # YOLOv10
            (E2EDetectLoss, "landmark.core.loss.v10DetectLoss"),  # YOLOv10
...
def torch_safe_load(weight, safe_only=None):
    ...
    Examples:
        >>> from landmark.nn.tasks import torch_safe_load
        >>> ckpt, file = torch_safe_load("path/to/best.pt", safe_only=True)
    """
    from landmark.core.downloads import GITHUB_ASSETS_NAMES, attempt_download_asset
    ...
    def _load():
        with temporary_modules(
            modules={
                # Scoped aliases are active only while unpickling a legacy checkpoint.
                **LEGACY_LANDMARK2_MODULES,
                "ultralytics": "landmark",
                "ultralytics.yolo.utils": "landmark.core",
                "ultralytics.yolo.v8": "landmark.core",
                "ultralytics.yolo.data": "landmark.data",
                "ultralytics.nn": "landmark.nn",
                "ultralytics.nn.tasks": "landmark.nn.tasks",
                "ultralytics.nn.modules": "landmark.nn.modules",
                "ultralytics.nn.modules.block": "landmark.nn.modules.block",
                "ultralytics.nn.modules.conv": "landmark.nn.modules.conv",
                "ultralytics.nn.modules.head": "landmark.nn.modules.head",
                "ultralytics.nn.modules.transformer": "landmark.nn.modules.transformer",
                "ultralytics.nn.modules.oa26": "landmark.nn.modules.oa26",
                "ultralytics.nn.modules.oa26.pose_heads": "landmark.nn.modules.oa26.pose_heads",
                "ultralytics.nn.modules.oa26_region_refine": "landmark.nn.modules.oa26_region_refine",
                "ultralytics.nn.modules.oa26_region_refine.pose_head": "landmark.nn.modules.oa26_region_refine.pose_head",
                "ultralytics.utils": "landmark.core",
                "ultralytics.utils.loss": "landmark.core.loss",
                "ultralytics.utils.metrics": "landmark.core.metrics",
                "ultralytics.utils.ops": "landmark.core.ops",
                "ultralytics.utils.tal": "landmark.core.tal",
                "ultralytics.utils.torch_utils": "landmark.core.torch_utils",
                "ultralytics.utils.oa26.loss": "landmark.core.loss",
                "ultralytics.utils.oa26_region_refine.loss": "landmark.core.loss",
            },
            attributes={
                "landmark.nn.modules.block.Silence": "torch.nn.Identity",  # YOLOv9e
                "landmark.nn.tasks.YOLOv10DetectionModel": "landmark.nn.tasks.DetectionModel",  # YOLOv10
                "landmark.core.loss.v10DetectLoss": "landmark.core.loss.E2EDetectLoss",  # YOLOv10
...
def yaml_model_load(path):
    ...
    # Uknee YAMLs intentionally keep a stable default scale while still
    # allowing the standard n/s/m/l/x filename convention to override it.
