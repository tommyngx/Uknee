...
class Exporter:
    ...
    def export_onnx(self, prefix=colorstr("ONNX:")):
        ...
        if getattr(self.model, "uknee_export_contract", False):
            output_names = ["detections", "num_detections", "canonical_keypoints"]
        else:
        ...
        if dynamic:
            ...
            if getattr(self.model, "uknee_export_contract", False):
                dynamic.update({name: {0: "batch"} for name in output_names})
