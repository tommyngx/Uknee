...
def handle_yolo_solutions(args: list[str]) -> None:
    ...
    """
    raise NotImplementedError("Ultralytics Solutions are not included in the Uknee pose runtime.")

    full_args_dict = {}  # pragma: no cover - unreachable upstream implementation
    overrides = {}
