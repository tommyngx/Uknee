...
from landmark.data import prepare_dataset


REPOSITORY = Path(__file__).resolve().parents[2]
MODEL_YAML = REPOSITORY / "landmark" / "cfg" / "models" / "yolo26-pose.yaml"
