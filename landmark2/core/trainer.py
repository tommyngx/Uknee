...
from landmark2.core.config import _YOLO_CLI_COMMAND, get_cfg, get_save_dir
from landmark2.data.data_utils import check_cls_dataset, check_det_dataset, convert_ndjson_to_yolo_if_needed
from landmark2.nn.distill_model import DistillationModel
from landmark2.nn.tasks import load_checkpoint
from landmark2.core.muon import MuSGD
...
from landmark2.core.autobatch import check_train_batch_size
from landmark2.core.checks import check_amp, check_file, check_imgsz, check_model_file_from_stem, print_args
from landmark2.core.dist import ddp_cleanup, generate_ddp_command
from landmark2.core.files import get_latest_run
        ...
        for k, v in self.model.named_parameters():
            ...
            if any(x in k for x in freeze_layer_names):
                ...
                LOGGER.warning(
                    ...
                    "See landmark2.core.trainer for customization of frozen layers."
                )
...
class MultiTrainer:
    ...
    def train(self):
        ...
        from landmark2.core.patches import torch_load, torch_save
    ...
    def plot_results(self):
        ...
        from landmark2.core.config import TASK2METRIC
