...
def generate_ddp_file(trainer: BaseTrainer) -> str:
    ...
    Args:
        trainer (landmark2.core.trainer.BaseTrainer): The trainer containing training configuration and arguments.
...
if __name__ == "__main__":
    ...
    from landmark2.core import DEFAULT_CFG_DICT
...
def generate_ddp_command(trainer: BaseTrainer) -> tuple[list[str], str]:
    ...
    Args:
        trainer (landmark2.core.trainer.BaseTrainer): The trainer containing configuration for distributed training.
...
def ddp_cleanup(trainer: BaseTrainer, file: str) -> None:
    ...
    Args:
        trainer (landmark2.core.trainer.BaseTrainer): The trainer used for distributed training.
