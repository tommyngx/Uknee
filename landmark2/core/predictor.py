...
from landmark2.core.config import get_cfg, get_save_dir
from landmark2.data import load_inference_source
from landmark2.data.augment import LetterBox
from landmark2.nn.autobackend import AutoBackend
from landmark2.core import DEFAULT_CFG, LOGGER, MACOS, WINDOWS, callbacks, colorstr, ops
from landmark2.core.checks import check_imgsz, check_imshow
from landmark2.core.files import increment_path
from landmark2.core.torch_utils import attempt_compile, select_device, smart_inference_mode
...
class BasePredictor:
    ...
    def __call__(self, source=None, model=None, stream: bool = False, *args, **kwargs):
        ...
        Returns:
            (list[landmark2.core.results.Results] | generator): Results objects or generator of Results objects.
        """
        self.stream = stream
        if stream:
    ...
    def stream_inference(self, source=None, model=None, *args, **kwargs):
        ...
        Yields:
            (landmark2.core.results.Results): Results objects.
        """
