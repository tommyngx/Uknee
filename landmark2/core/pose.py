...
from landmark2.core import DEFAULT_CFG, ops
...
class PosePredictor(DetectionPredictor):
    ...
    Examples:
        ...
        >>> from landmark2.core.pose import PosePredictor
...
from landmark2.nn.modules.oa26 import OA26HeatmapPose, OA26SimCCPose
from landmark2.nn.modules.oa26_region_refine import OA26RegionRefinePose
from landmark2.nn.tasks import PoseModel
from landmark2.core import DEFAULT_CFG, RANK
from landmark2.core.training_plot import plot_v9_performance_on_epoch_end
from landmark2.core.torch_utils import unwrap_model
...
class PoseTrainer(DetectionTrainer):
    ...
    Examples:
        >>> from landmark2.core.pose import PoseTrainer
...
from landmark2.core import ops
from landmark2.core.metrics import OKS_SIGMA, PoseMetrics, kpt_iou
...
class PoseValidator(DetectionValidator):
    ...
    Examples:
        >>> from landmark2.core.pose import PoseValidator
