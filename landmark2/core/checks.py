...
def parse_requirements(file_path=ROOT.parent / "requirements.txt", package=""):
    ...
    Examples:
        >>> from landmark2.core.checks import parse_requirements
...
def check_file(file, suffix="", download=True, download_dir=".", hard=True):
    ...
    if (
        ...
        from landmark2.core.callbacks.platform import resolve_platform_uri
...
def check_yolo(verbose=True, device=""):
    ...
    from landmark2.core.torch_utils import select_device
...
def collect_system_info():
    ...
    from landmark2.core import ENVIRONMENT  # scope to avoid circular import
    from landmark2.core.torch_utils import get_cpu_info, get_gpu_info
...
def check_amp(model):
    ...
    Examples:
        ...
        >>> from landmark2.core.checks import check_amp
        >>> model = YOLO("yolo26n.pt").model.cuda()
        >>> check_amp(model)
    """
    from landmark2.core.torch_utils import autocast
...
def is_intel():
    ...
    """
    from landmark2.core.torch_utils import get_cpu_info
