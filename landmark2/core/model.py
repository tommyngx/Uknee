...
from landmark2.core.config import TASK2DATA, get_cfg, get_save_dir
from landmark2.core.results import Results
from landmark2.nn.tasks import guess_model_task, load_checkpoint, yaml_model_load
...
class Model(torch.nn.Module):
    ...
    Attributes:
        ...
        metrics (landmark2.core.metrics.DetMetrics): The latest training/validation metrics.
    ...
    def __call__(
        ...
        **kwargs: Any,
        ...
        Returns:
            (list[landmark2.core.results.Results]): A list of prediction results, each encapsulated in a Results
                object.
    ...
    def is_hub_model(model: str) -> bool:
        ...
        Examples:
            ...
            False
        """
        # The Uknee vendored runtime is deliberately local-only and does not
        # include the Ultralytics HUB client.
        return False
    ...
    def save(self, filename: str | Path = "saved_model.pt") -> None:
        ...
        from landmark2 import __version__
    ...
    def predict(
        ...
        **kwargs: Any,
        ...
        Returns:
            (list[landmark2.core.results.Results] | list[torch.Tensor]): Prediction results as `Results` objects, or
    ...
    def track(
        ...
        **kwargs: Any,
        ...
        Returns:
            (list[landmark2.core.results.Results]): A list of tracking results, each a Results object.
        ...
        """
        raise NotImplementedError("Tracking is not included in the local-only Uknee pose runtime.")
    ...
    def val(
        ...
        **kwargs: Any,
        ...
        Args:
            validator (landmark2.core.validator.BaseValidator, optional): An instance of a custom validator class
                for validating the model.
            **kwargs (Any): Arbitrary keyword arguments for customizing the validation process.

        Returns:
            (landmark2.core.metrics.DetMetrics): Validation metrics obtained from the validation process. The
    ...
    def benchmark(self, data=None, format="", verbose=False, **kwargs: Any):
        ...
        uses the 'benchmark' function from the landmark2.core.benchmarks module. The benchmarking is configured using
        ...
        """
        self._check_is_pytorch_model()
        from landmark2.core.benchmarks import benchmark
    ...
    def train(
        ...
        **kwargs: Any,
        ...
        Returns:
            (landmark2.core.metrics.DetMetrics | dict | None): Training metrics if available and training is
        ...
        if isinstance(args.get("data"), (list, tuple)):  # fine-tune a single base model across multiple datasets
            from landmark2.core.trainer import MultiTrainer
    ...
    def tune(
        ...
        **kwargs: Any,
        ...
        is enabled, it leverages the 'run_ray_tune' function from the landmark2.core.tuner module. Otherwise, it uses
        ...
        self._check_is_pytorch_model()
        if use_ray:
            from landmark2.core.tuner import run_ray_tune
    ...
    def names(self) -> dict[int, str]:
        ...
        using the 'check_class_names' function from the landmark2.nn.autobackend module. If the predictor is not
...
class YOLO(Model):
    """Pose-focused YOLO frontend retained by landmark2."""

    @property
    def task_map(self) -> dict[str, dict[str, Any]]:
        from landmark2.core.detect import DetectionPredictor, DetectionTrainer, DetectionValidator
        from landmark2.core.pose import PosePredictor, PoseTrainer, PoseValidator
        from landmark2.nn.tasks import DetectionModel, PoseModel
