...
from landmark2.core.model import Model
...
from landmark2.core import DEFAULT_CFG_DICT, LOGGER, RANK, ops
from landmark2.core.targets import extract_canonical_image_keypoints, gaussian_heatmap_targets
from landmark2.core.torch_utils import model_info

from landmark2.data.schema import NUM_LANDMARKS, REGION_KEYPOINT_COUNTS, REGION_NAMES
from landmark2.models import HRNetW32, ViTPoseS
from landmark2.utils.validation import FlatPoseTrainerMixin, KneePoseValidator
...
class HeatmapPosePredictor(BasePredictor):
    ...
    def __init__(self, cfg=None, overrides=None, _callbacks=None):
        from landmark2.core import DEFAULT_CFG
