...
from landmark2.data.data_utils import IMG_FORMATS, img2label_paths
from landmark2.core import DATASETS_DIR, LOGGER, TQDM
...
def autosplit(
    ...
    Examples:
        ...
        >>> from landmark2.data.split import autosplit
        >>> autosplit()
