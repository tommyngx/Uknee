...
import torch
import landmark2  # noqa: F401 - bootstrap the pinned backend before absolute imports

from landmark2.core.targets import extract_canonical_image_keypoints
from landmark2.core.loss import OA26HeatmapPoseLoss
from landmark2.data.schema import class_path_masks
