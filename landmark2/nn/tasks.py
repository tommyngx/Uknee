...
from landmark2.nn.autobackend import check_class_names
from landmark2.nn.modules import (
    AIFI,
    C1,
    C2,
    C2PSA,
...
from landmark2.core.checks import REMOTE_FILE_PREFIXES, check_file, check_requirements, check_suffix, check_yaml
from landmark2.core.loss import (
    E2ELoss,
    PoseLoss26,
...
from landmark2.core.ops import make_divisible
from landmark2.core.patches import torch_load
from landmark2.core.plotting import feature_visualization
from landmark2.core.torch_utils import (
    fuse_conv_and_bn,
    fuse_deconv_and_bn,
    initialize_weights,
    intersect_dicts,
...
from landmark2.nn.modules.oa26 import (
    ConvNeXtV2N,
    ConvNeXtV2T,
    HRNet,
    HRNetLite,
...
from landmark2.nn.modules.oa26_region_refine import OA26RegionRefinePose
from landmark2.core.loss import OA26HeatmapPoseLoss, OA26SimCCPoseLoss
from landmark2.core.loss import OA26RegionRefinePoseLoss
...
class RTDETRDetectionModel(DetectionModel):
    ...
    def init_criterion(self):
        ...
        raise NotImplementedError("RT-DETR is not part of the landmark2 pose-only runtime")
...
class WorldModel(DetectionModel):
    ...
    def get_text_pe(self, text, batch=80, cache_clip_model=True):
        ...
        """
        from landmark2.nn.text_model import build_text_model
...
class YOLOEModel(DetectionModel):
    ...
    def loss(self, batch, preds=None):
        ...
        """
        if not hasattr(self, "criterion"):
            from landmark2.core.loss import TVPDetectLoss
...
class YOLOESegModel(YOLOEModel, SegmentationModel):
    ...
    def loss(self, batch, preds=None):
        ...
        """
        if not hasattr(self, "criterion"):
            from landmark2.core.loss import TVPSegmentLoss
...
class _SafeLoad:
    ...
    def _build(cls):
        ...
        import landmark2.nn.modules as ul_nn
        import landmark2.nn.tasks as ul_tasks
        ...
        from landmark2.core.loss import E2EDetectLoss
        ...
        allow += [
            (nn.Identity, "landmark2.nn.modules.block.Silence"),  # YOLOv9e
            (DetectionModel, "landmark2.nn.tasks.YOLOv10DetectionModel"),  # YOLOv10
            (E2EDetectLoss, "landmark2.core.loss.v10DetectLoss"),  # YOLOv10
...
def torch_safe_load(weight, safe_only=None):
    ...
    Examples:
        >>> from landmark2.nn.tasks import torch_safe_load
        >>> ckpt, file = torch_safe_load("path/to/best.pt", safe_only=True)
    """
    from landmark2.core.downloads import GITHUB_ASSETS_NAMES, attempt_download_asset
    ...
    def _load():
        with temporary_modules(
            modules={
                # Scoped aliases are active only while unpickling a landmark v1 checkpoint.
                "ultralytics": "landmark2",
                "ultralytics.yolo.utils": "landmark2.core",
                "ultralytics.yolo.v8": "landmark2.core",
                "ultralytics.yolo.data": "landmark2.data",
                "ultralytics.nn": "landmark2.nn",
                "ultralytics.nn.tasks": "landmark2.nn.tasks",
                "ultralytics.nn.modules": "landmark2.nn.modules",
                "ultralytics.nn.modules.block": "landmark2.nn.modules.block",
                "ultralytics.nn.modules.conv": "landmark2.nn.modules.conv",
                "ultralytics.nn.modules.head": "landmark2.nn.modules.head",
                "ultralytics.nn.modules.transformer": "landmark2.nn.modules.transformer",
                "ultralytics.nn.modules.oa26": "landmark2.nn.modules.oa26",
                "ultralytics.nn.modules.oa26.pose_heads": "landmark2.nn.modules.oa26.pose_heads",
                "ultralytics.nn.modules.oa26_region_refine": "landmark2.nn.modules.oa26_region_refine",
                "ultralytics.nn.modules.oa26_region_refine.pose_head": "landmark2.nn.modules.oa26_region_refine.pose_head",
                "ultralytics.utils": "landmark2.core",
                "ultralytics.utils.loss": "landmark2.core.loss",
                "ultralytics.utils.metrics": "landmark2.core.metrics",
                "ultralytics.utils.ops": "landmark2.core.ops",
                "ultralytics.utils.tal": "landmark2.core.tal",
                "ultralytics.utils.torch_utils": "landmark2.core.torch_utils",
                "ultralytics.utils.oa26.loss": "landmark2.core.loss",
                "ultralytics.utils.oa26_region_refine.loss": "landmark2.core.loss",
            },
            attributes={
                "landmark2.nn.modules.block.Silence": "torch.nn.Identity",  # YOLOv9e
                "landmark2.nn.tasks.YOLOv10DetectionModel": "landmark2.nn.tasks.DetectionModel",  # YOLOv10
                "landmark2.core.loss.v10DetectLoss": "landmark2.core.loss.E2EDetectLoss",  # YOLOv10
