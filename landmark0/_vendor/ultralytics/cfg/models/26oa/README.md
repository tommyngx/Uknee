...
| --- | --- | --- | --- | --- | --- | --- |
| v1 | `ultralytics/cfg/models/26oa/yolo26-posev1.yaml` | YOLO26-style P2-P5 | `OA26HeatmapPose` | Heatmap + coord + neighbour + curve | Standard pose | Test full auxiliary landmark0 supervision |
...
- v9 extracts one `20 x 20` P4 ROI per detected class instance. Queries cross-attend to the complete ROI and
  self-attend only within their own bone; it has no cross-class attention and no patch-per-landmark0 sampling.
...
- per-region landmark0 error: femur, tibia, joint margin, osteophyte-related points
