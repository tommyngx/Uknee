...
- MESKO4GF2 model YAMLs are exposed through `landmark0/cfg/models` with four
...
- OA26 auxiliary heatmap target construction is class-aware and maps all four
  region rows to the canonical 129-landmark0 order.
...
- Pose training supports flat checkpoints, MRE-based `best.pt`, medical metrics
  and consolidated reporting through the landmark0 integration layer.
