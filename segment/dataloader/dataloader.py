...
from segment.dataloader.augment import (
    build_train_transform,
    build_val_transform,
    resolve_aug_strategy,
)
from segment.dataloader.dataset import (
    BUSBRADatasets,
    CHASEDB1Dataset,
    Covid19CTScanDataset,
    DRIVEdataset,
    DataScienceBowl2018Dataset,
    GlasDataSets,
    KvasirSEGDataset,
    KvasirSEGDatasetVAL,
    MedicalDataSets,
...
def getDataloader(args):
    ...
    if "COVID" in args.base_dir: # for COVID19;
        ...
        from segment.dataloader.dataset_synapse import Synapse_dataset, RandomGenerator_synapse
        ...
        db_train = DataScienceBowl2018Dataset(
            args.base_dir,
            image_size=img_size,
            mode='train',
            transform=train_transform,
        )
        db_val = DataScienceBowl2018Dataset(
            args.base_dir,
            image_size=img_size,
            mode='val',
            transform=val_transform,
        )
        db_test = DataScienceBowl2018Dataset(
            args.base_dir,
            image_size=img_size,
            mode='test',
            transform=val_transform,
        ...
        from segment.dataloader.dataset_XRay import MontgomeryXRAYDataSet
...
def getZeroShotDataloader(args):
    ...
    if args.zero_shot_dataset_name in ["busi","isic18","tuscui","bus","Benign","malignant", "stare"] or (
        ...
        from segment.dataloader.dataset_XRay import MIHXRAYDataSet
