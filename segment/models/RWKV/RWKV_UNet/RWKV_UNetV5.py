...
# Compatibility for code importing the old factory directly. CLI/model registry
# intentionally exposes this compact architecture as RWKV_UNetV5.
med_axial_rwkv6_unet = med_axial_rwkv5_unet
