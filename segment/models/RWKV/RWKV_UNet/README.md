...
Quy ước hiện tại: V5 là MedAxial bản gọn; V6 là matrix-state bản full.

| Đặc tính | RWKV_UNet (V1) | RWKV_UNetV2 | RWKV_UNetV3 | RWKV_UNetV4 | RWKV_UNetV5 (gọn) |
| :--- | :--- | :--- | :--- | :--- | :--- |
...
### 5. [RWKV_UNetV5 (MedAxial-RWKV6 U-Net gọn)](./RWKV_UNetV5.py)
...
### 6. [RWKV_UNetV6 (Matrix-State full)](./RWKV_UNetV6.py)

* **Kiến trúc:** Bản RWKV-6 matrix-state đầy đủ, quét hai chiều theo từng trục và ưu tiên độ trung thực kiến trúc. Bản này nhiều parameter và chậm hơn V5, phù hợp khi cần benchmark full model.
